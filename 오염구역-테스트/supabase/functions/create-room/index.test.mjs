...
const req = () => new Request('https://example.invalid', { method: 'POST', headers: { Authorization: 'Bearer fake-user-token' }, body: JSON.stringify({ host_user_id: 'attacker', max_players: 99 }) });
